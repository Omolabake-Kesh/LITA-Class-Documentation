...
The data set was provided as part of the course to enable us work on a huge data and exploir our acquired skill. The data is selected from a public domain and refereced. My duty is to 
 ensure that the given data is well presented and sunnarized for a better understanding even to a common man.
...
- I Thorougly studied the data and mentally analized what can be done to these data before analysing, to give understanding through my presentation and summary, so that my client will be able make an informed decision concerning the data.
...
## Caution:
- I ensured i work with the Questions of my instructors and to make table where neccessary.
...
- I removed the decimal point of the figure so that my pivot table will be on one sheet to be seen and none will be hidden within the bars
...
Total number of rolls in the data set 40079, Remaining 9921 rolls after removing Duplicates, Converted to Table, I did Pivot Table,Total Revenue, Average and Percentage. 
...
I dont know there may be other factors too affecting the month of Febuary like buying an item for a birthday celibrant of the month of Febuary amog others. Seeing that the month of Febuary is constantly increasing, I will advise my client to focus more on the month of Febuary by stocking item needed in the month of Febuary for his/her customers so as to make more sale and not forsaking other months too but knowning the items needed by the customers in other months. 
...
Fig 2 Customer Subscription: The above picture shows the different type of subscription prefered by different customers in different region
